...
{
    public class ProvincieBestandLezer : IProvincieBestandLezer
    {
        ...
        public List<Provincie> LeesBestanden(string folder, List<string> bestandsNamen)
        {
            ...
            {
                sr.ReadLine(); // we skippen eerste lijn want header
                string line;
                while ((line = sr.ReadLine()) != null)
                {
                    ...
                    if (taalCode != "nl" || !provincieIDs.Contains(provincieId))
                    {
                        continue;
                    }
